...
import 'package:masafat/controller/mappickup_controller.dart';
import 'package:masafat/core/class/statusrequest.dart';

class MapPickUp extends StatelessWidget {
  final MapControllerPickUp mapController = Get.put(MapControllerPickUp());
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            mapController.goToDropOffMap();
                            print('Selected location: ${mapController.selectedLocation.value}');
                          },
...
class DataSearch extends SearchDelegate<String?> {
  ...
  Widget buildSuggestions(BuildContext context) {
    final MapControllerPickUp mapController = Get.find<MapControllerPickUp>();
